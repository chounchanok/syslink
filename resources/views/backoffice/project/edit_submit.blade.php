            ...
            <div class="content">
                ...
                <div class="top-bar">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('project',$submit->project_id)}}">Project</a></li>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-8">
                        <!-- BEGIN: Form Layout -->
                        <form action="{{route('project.submit_update')}}" method="POST" enctype="multipart/form-data"">
                            @csrf
                        <div class="intro-y box p-5">
                            <input type="hidden" name="id" value="{{$submit->id}}" id="">
                            <div>
                                <label class="form-label">name</label>
                                <input id="crud-form-1" type="text" class="form-control" name="name" value="{{$submit->name}}">
                            </div>
