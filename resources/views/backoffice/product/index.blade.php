                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <form action="{{route('product.add')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" name="name" required id="" {{auth()->guard('admin')->user()->permission == 1 ? null:'disabled' }}>
                            <label for="">Stock no.</label>
                            <input type="text" name="sku" required id="" {{auth()->guard('admin')->user()->permission == 1 ? null:'disabled' }}>
                            <label for="">Unit</label>
                            <input type="text" name="unit" required id="" {{auth()->guard('admin')->user()->permission == 1 ? null:'disabled' }}>
                            <label for="">Quantity</label>
                            <input type="number" name="qty" required id="" {{auth()->guard('admin')->user()->permission == 1 ? null:'disabled' }}>
                            <button class="btn btn-primary shadow-md mr-2" {{auth()->guard('admin')->user()->permission == 1 ? null:'disabled' }}
                                title="{{ auth()->guard('admin')->user()->permission == 1 ? '' : 'User does not have permission to edit data in the system' }}">Add product name</button>
                        </form>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action">
                                        <div class="flex justify-center">
                                            ...
                                            <a class="flex items-center mr-3" href="{{route('product.edit',$item->id)}}"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i>Edit</a>
                                            @endif
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
                        ...
                        <select class="w-20 form-select box mt-3 sm:mt-0" id="show" name="show" onchange="document.location.href=`{{url('/product')}}?show=${this.value}`" >
