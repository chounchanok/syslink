<div class="mobile-menu md:hidden">
    ...
    {{-- @if (auth()->user()->role == 'MD') --}}
        <li>
            <a href="{{url('/')}}" class="menu {{request()->is('backoffice') ? 'menu--active' : ''}}">
                <div class="menu__icon"> <i data-lucide="Home"></i> </div>
    ...
    @if (auth()->guard('admin')->user()->role == "superadmin" || auth()->guard('admin')->user()->role == "superadmin")

    <li>
        <a href="{{url('/admin')}}" class="menu {{request()->is('admin')|| request()->is('admin/*') ? 'menu--active' : ''}}">
     ...
     @endif
     <li>
     <a href="javascript:;.html" class="menu {{request()->is('technician') || request()->is('engineer') || request()->is('sale')||request()->is('technician/*') || request()->is('engineer/*') ||request()->is('sale/*') ?'menu--active':''}}">
        <div class="menu__icon"> <i data-lucide="folder"></i> </div>
        <div class="menu__title"> User <i data-lucide="chevron-down" class="menu__sub-icon transform rotate-180"></i> </div>
    </a>
    <ul class="{{request()->is('technician') || request()->is('engineer') || request()->is('sale')||request()->is('technician/*') || request()->is('engineer/*') ||request()->is('sale/*') ?'menu__sub-open':''}}">
        <li>
            <a href="{{url('technician')}}" class="menu {{request()->is('technician') || request()->is('technician/*')?'menu--active':''}}">
                <div class="menu__icon"> <i data-lucide="user"></i> </div>
                <div class="menu__title"> Technician </div>
            </a>
        </li>
        <li>
            <a href="{{url('engineer')}}" class="menu  {{request()->is('engineer') || request()->is('engineer/*')?'menu--active':''}}">
                <div class="menu__icon"> <i data-lucide="user"></i> </div>
                <div class="menu__title"> Engineer </div>
            </a>
        </li>
        <li>
            <a href="{{url('sale')}}" class="menu  {{request()->is('sale') || request()->is('sale/*')?'menu--active':''}}">
                <div class="menu__icon"> <i data-lucide="user"></i> </div>
                <div class="menu__title"> Sale </div>
            </a>
        </li>
    </ul>
</li>
    ...
    <li>
        <a href="{{url('team')}}" class="menu {{request()->is('team')|| request()->is('team/*') ? 'menu--active' : ''}}">
            <div class="side-menu__icon"> <i data-lucide="users"></i> </div>
            <div class="side-menu__title"> Team </div>
        </a>
    </li>
    <li>
        <a href="{{url('project')}}" class="menu {{request()->is('project')|| request()->is('project/*') ? 'menu--active' : ''}}">
    ...
    <li>
        ...
        <a href="{{url("job")}}" class="menu {{request()->is('job')|| request()->is('job/*') ? 'menu--active' : ''}}">
            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
