                ...
                <div class="top-bar">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">ส่งงาน อื่นๆ</li>
                        </ol>
                    </nav>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-8">
                        ...
                        <div class="intro-y box p-5">
                            <div>
                                <label class="form-label"> มิตเตอร์ไฟฟ้า </label>
                                <div class="mx-6 pb-8">
                            ...
                            <div>
                                <label class="form-label"> เต้ารับเดิมบริเวณที่จอดรถ (หากมี) </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                            ...
                            <div>
                                <label class="form-label"> ตู้เมนเบรกเกอร์เดิม (วงจร 1) </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                            ...
                            <div>
                                <label class="form-label"> เบรกเกอร์ใหม่ที่ใส่ในตู้เมน (วงจร 2) </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                            ...
                            <div>
                                <label class="form-label"> ตำแหน่งติดตั้งอุปกรณ์ชาร์จ </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                            ...
                            <div>
                                <label class="form-label"> Serial บนเครื่อง EV Charger </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                            ...
                            <div>
                                <label class="form-label"> Serial บนกล่อง </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                                        @foreach ($file_job as $step7)
                                            @if ($step7->step_file == 7)
                                            <div class="max-h-full px-2">
                                                <div class="h-full bg-slate-100 dark:bg-darkmode-400 rounded-md">
                                                    <h3 class="h-full font-medium flex items-center justify-center text-2xl">
                                                        <div class="row">
                            ...
                            <div>
                                <label class="form-label"> Consumer Unit ใหม่ (เปิดฝา ถ่ายให้เห็น RCD ข้างใน) </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                            ...
                            <div>
                                <label class="form-label"> แนวการเดินสายไฟ </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                                        @foreach ($file_job as $step9)
                                            @if ($step9->step_file == 9)
                                            <div class="max-h-full px-2">
                                                <div class="h-full bg-slate-100 dark:bg-darkmode-400 rounded-md">
                                                    <h3 class="h-full font-medium flex items-center justify-center text-2xl">
                                                        <div class="row">
                                                            <div class="h-set">
                                                                <img style="object-fit: cover;" src="{{asset("$step9->path/$step9->file_name")}}" data-action="zoom"/>
                                                            </div>
                                                            <div class="text-center mt-2">
                                                                <a href="{{ asset("$step9->path/$step9->file_name") }}" download class="btn btn-sm btn-primary">ดาวน์โหลด</a>
                                                            </div>
                                                        </div>
                                                    </h3>
                                                </div>
                            ...
                            <div>
                                <label class="form-label"> วัด Voltage ที่เมนเบรกเกอร์ </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                                        @foreach ($file_job as $step10)
                                            @if ($step10->step_file == 10)
                                            <div class="max-h-full px-2">
                                                <div class="h-full bg-slate-100 dark:bg-darkmode-400 rounded-md">
                                                    <h3 class="h-full font-medium flex items-center justify-center text-2xl">
                                                        <div class="row">
                                                            <div class="h-set">
                                                                <img style="object-fit: cover;" src="{{asset("$step10->path/$step10->file_name")}}" data-action="zoom"/>
                                                            </div>
                                                            <div class="text-center mt-2">
                                                                <a href="{{ asset("$step10->path/$step10->file_name") }}" download class="btn btn-sm btn-primary">ดาวน์โหลด</a>
                                                            </div>
                                                        </div>
                                                    </h3>
                                                </div>
                            ...
                            <div>
                                <label class="form-label"> วัด Voltage ที่อุปกรณ์ชาร์จ </label>
                                <div class="mx-6 pb-8">
                                    <div class="responsive-mode">
                                        @foreach ($file_job as $step11)
                                            @if ($step11->step_file == 11)
                                            <div class="max-h-full px-2">
                                                <div class="h-full bg-slate-100 dark:bg-darkmode-400 rounded-md">
                                                    <h3 class="h-full font-medium flex items-center justify-center text-2xl">
                                                        <div class="row">
                                                            <div class="h-set">
                                                                <img style="object-fit: cover;" src="{{asset("$step11->path/$step11->file_name")}}" data-action="zoom"/>
                                                            </div>
                                                            <div class="text-center mt-2">
                                                                <a href="{{ asset("$step11->path/$step11->file_name") }}" download class="btn btn-sm btn-primary">ดาวน์โหลด</a>
                                                            </div>
                                                        </div>
                                                    </h3>
                                                </div>
