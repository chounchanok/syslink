            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    {{-- <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <a class="btn btn-primary shadow-md mr-2" href="{{url('/team/add')}}">Add New Team</a>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            {{-- <a class="flex items-center mr-3" href="{{url("/team/view/$tm->id")}}"><i data-lucide="file-text" class="w-4 h-4 mr-1"></i>รายชื่อคนในทีม</a> --}}
                                            @php
                ...
                <div id="delete-team{{$item->id}}" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{url("/team/delete/user")}}" method="post">
                                @csrf
                            <div class="modal-body p-0">
                                ...
                                <div class="px-5 pb-8 text-center">
                                    <button type="submit" data-tw-dismiss="modal" class="btn btn-outline-secondary w-24 mr-1">Cancel</button>
