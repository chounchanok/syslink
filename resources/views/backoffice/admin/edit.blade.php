            ...
            <div class="content">
                ...
                <div class="top-bar">
                    ...
                    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/backoffice/admin">Admin</a></li>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-8">
                        <!-- BEGIN: Form Layout -->
                        <form action="{{url('/admin/edit/sub')}}" id="saveForm" method="POST" enctype="multipart/form-data">
                            @csrf
                        <div class="intro-y box p-5">
                            ...
                            <div>
                                ...
                                <input id="crud-form-1" type="text" class="form-control w-full" required name="username" placeholder="Input text" value="{{$admin->username}}">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input id="password_confirmation" type="password" class="form-control w-full"  name="password_confirmation" placeholder="confirm password">
                            </div>
                            <div>
                                <label for="crud-form-1" class="form-label">Name</label>
                                <input id="crud-form-1" type="text" class="form-control w-full" required name="name" value="{{$admin->name}}" placeholder="name">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="permission" id="" class="form-control">
                                    ...
                                    <option value="0" {{$admin->permission == 0 ? "selected":""}}> ดูได้อย่างเดียว </option>
                                    <option value="1" {{$admin->permission == 1 ? "selected":""}}> สามารถแก้ไขได้</option>
                                </select>
                            </div>
                            @else
                            <input type="hidden" name="permission" value="1" id="">
                            @endif


                            <div class="text-right mt-5">
                                <a href="{{url('/admin')}}" class="btn btn-outline-secondary w-24 mr-1">Cancel</a>
