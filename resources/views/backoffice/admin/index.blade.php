...
<html lang="en" class="light">
    ...
    <body class="py-5">
        ...
        <div class="flex">
            ...
            <div class="content">
                        ...
                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            {{-- <div class="w-56 relative text-slate-500"> --}}
                                ...
                                <a class="btn  shadow-md mr-2 {{ auth()->guard('admin')->user()->role == 'superadmin' ? 'btn-primary' : 'btn-secondary disabled-link' }}"
                                    href="{{ auth()->guard('admin')->user()->role == 'superadmin' ? url('/admin/add') : '#' }}" >Add New Admin</a>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <a class="flex items-center mr-3" href="{{url("/admin/edit/$ad->id")}}"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i>Edit</a>
                                            @if ($ad->role != 'superadmin')
                                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-admin{{$ad->id}}" class="flex items-center mr-3" style="color: red"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete</a>
                                            @endif
                                            @endif
                                        </div>
                                    </td>
                ...
                <div id="delete-admin{{$item->id}}" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
   ...
   <script>
    function searchDoc(search,project,status,sale,engineer,team){
        window.location.replace('/admin?search='+document.getElementById(search).value);
    }
</script>
    </body>
</html>
