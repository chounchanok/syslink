            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        ...
                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            ...
                            <a class="btn  shadow-md mr-2 {{ auth()->guard('admin')->user()->role == 'superadmin' ? 'btn-primary' : 'btn-secondary disabled-link' }}"
                                href="{{ auth()->guard('admin')->user()->role == 'superadmin' ? url('/engineer/add') : '#' }}" >Add New Engineer</a>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <a class="flex items-center mr-3" href="{{url("/engineer/edit/$ad->id")}}"><i data-lucide="check-square" class="w-4 h-4 mr-1"></i>Edit</a>
                                            @endif
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
                        ...
                        {{-- <select class="w-20 form-select box mt-3 sm:mt-0" id="show" name="show" onchange="document.location.href=`{{url('/engineer')}}?show=${this.value}`" >
                ...
                <div id="delete-engineer{{$item->id}}" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{url("/engineer/delete")}}" method="post">
                                @csrf
                            <div class="modal-body p-0">
        ...
        <script>
          ...
          <script>
            function searchDoc(search,project,status,sale,engineer,team){
                window.location.replace('/engineer?search='+document.getElementById(search).value);
            }
        </script>
    </body>
</html>
