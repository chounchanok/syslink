...
$year = Carbon\Carbon::now()->thaidate('Y');
    ...
    // รูปแบบวันที่
    $formattedStartDates = $startDate->format('Y-m-d H:i');
    $formattedEndDates = $endDate->format('Y-m-d H:i');
...
<body>
    <table>
        <thead>
            ...
            <tr align="center">
                <th colspan="5" style="border: 1px solid black;border-collapse: collapse;width: 80px;text-align: center;"> สรุปงานติดตั้ง วงจร ประจำเดือน {{$month_job}} {{$year}}</th>
            </tr>
            <tr align="center">
