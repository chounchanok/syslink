...
<body>
    <table>
        <thead>
            ...
            <tr align="center">
                <th colspan="7" style="border: 1px solid black;border-collapse: collapse;width: 80px;text-align: center;"> สรุปติดตั้งงาน โปรเจคอื่นๆ ประจำเดือน {{$month_job}} {{$year}}</th>
            </tr>
            <tr align="center">
                ...
                <th style="border: 1px solid black;border-collapse: collapse;width: 80px;text-align: center;"> วันที่ติดตั้ง </th>
